...
var store = require('./store').store,
    ...
    getAccessToken = function (requestToken, tokenSecret, requestVerifier, callback) {
        var oa = oAuthConsumer();
        oa.getOAuthAccessToken(requestToken, tokenSecret, requestVerifier, callback);
    },

    verifyCredentials = function (accessToken, callback) {
    ...
    searchTweets = function (accessToken, searchOptions, callback) {
        store.getSecret(accessToken, function (error, secret) {
            if (error) {
                callback(error);
                return;
    ...
    performProxyTwitterRequest = function (opts) {
        opts = opts || {};
